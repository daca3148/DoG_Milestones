	...
	<div class="container">
	  ...
	  <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
		<ul class="navbar-nav">
		  ...
		  <!--<form action="stock">
			  <input class="input-label form-control" placeholder="Trade Code" name="symbol" type="text"></input>
		  </form>-->
		</ul>
	  </div>
	...
	<div class="container">		
		<div class="row">
			<div class="col-lg-12 col-sm-12 col-xs-12">
				<p class="copyright">Copyright &copy; 2019. DoG Trade All rights reserved.</p>
			</div><!--- END COL -->					
		</div><!--- END ROW -->					
	</div><!--- END CONTAINER -->
</div>
