function editProfile(){
	...
	if(btn.innerHTML == "Edit Profile"){
		...
		document.getElementById('img_div').innerHTML = "<form style='text-align:center' method='post'>Enter Profile Picture URL<br><input type='url' id='user_img' name='pic' accept='image/*'></form>"
	}
